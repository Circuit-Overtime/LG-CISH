...
% Author names, affiliations, contact details, and ORCIDs are provided in the
% separate Author Details file and intentionally omitted here for blinded review.
\author{}
\date{}
...
complete $40$-image codebook and implementation will be made publicly available
for reproducibility after blinded peer review.
...
codebook supporting the findings of this research are available in an anonymised
repository during peer review. The public repository address will be restored
after the blinded review process.
