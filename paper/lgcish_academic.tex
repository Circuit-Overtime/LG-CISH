...
Kadhim et al.\ [1] conducted a comprehensive survey of image steganography and
concluded that a trade-off always exists among payload capacity, imperceptibility,
and robustness. Similarly, Subramanian et al.\ [2] highlighted that modern
transform-domain schemes achieve superior image quality compared with
spatial-domain approaches but still rely on pixel modification. Mandal et al.\ [3]
...
analysis, RS analysis, and histogram-based methods have proven effective in
...
Kombrink et al.\ [4] presented a detailed survey of modern image-steganography
...
et al.\ [5] reviewed deep-learning-based steganalysis frameworks and showed that
deep neural architectures can successfully identify subtle embedding artifacts
across diverse multimedia formats. Likewise, Apau et al.\ [6] observed that even
...
Qin et al.\ [7] presented one of the most comprehensive surveys on coverless image
...
modifications are introduced during transmission. Meng et al.\ [8] further reviewed
...
Hu et al.\ [9] proposed a Joint Semantic Preserving Sparse Hashing (JSPSH) framework
...
Similarly, Li et al.\ [10] introduced a Semantic Preservation-Based Hash Code
...
retrieval and fine-grained image-retrieval applications [9,10], its integration with
...
\midrule
Kadhim et al.\ [1] & Spatial and transform-domain image steganography & Focuses on pixel-modification techniques and trade-offs among capacity, robustness and imperceptibility. & Need a pixel-modification-free (coverless) communication framework that completely avoids embedding artifacts. \\
Subramanian et al.\ [2] & Transform-domain (DCT, DWT, hybrid) & Improves image quality but still modifies transform coefficients. & Develop a framework eliminating coefficient modification while preserving security through semantic image selection. \\
Mandal et al.\ [3] & Hybrid transform-domain steganography & Vulnerable to advanced statistical and deep-learning steganalysis. & Design a steganalysis-resistant coverless communication system without altering image statistics. \\
Kombrink et al.\ [4] & CNN-based steganalysis survey & Demonstrates high detection accuracy against conventional steganography. & Develop communication methods that generate no embedding artifacts detectable by CNN-based steganalysis. \\
Kheddar et al.\ [5] & Deep-learning-based multimedia steganalysis & Detects subtle embedding traces even in optimized methods. & Introduce a communication paradigm based on semantic retrieval rather than embedding. \\
Apau et al.\ [6] & Statistical analysis of modern steganography & Hidden data still leaves statistical inconsistencies. & Remove statistical footprints through coverless semantic communication. \\
Qin et al.\ [7] & Coverless image steganography & Mainly relies on image retrieval, mapping and handcrafted descriptors. & Replace handcrafted descriptors with deep semantic embeddings and semantic hashing for robust retrieval. \\
Meng et al.\ [8] & Coverless image steganography & Database construction and semantic indexing remain challenging. & Develop an automatic semantic hash-mapping mechanism for scalable image retrieval. \\
Hu et al.\ [9] & Joint Semantic Preserving Sparse Hashing (JSPSH) & Designed for cross-modal retrieval, not secure communication. & Integrate semantic-preserving hashing into coverless image steganography for secure message transmission. \\
Li et al.\ [10] & Semantic Preservation-Based Hash Code Generation (SPHCG) & Focuses on fine-grained image retrieval only. & Extend semantic hashing to coverless steganographic communication and message reconstruction. \\
\bottomrule
\end{tabular}
\end{table}

Conventional steganography techniques modify image pixels and therefore remain
vulnerable to statistical and deep-learning-based steganalysis [3,8,9]. Existing
...
limited semantic expressiveness [1,5]. Current image retrieval-based systems
